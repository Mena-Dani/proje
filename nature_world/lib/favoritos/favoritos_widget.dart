...
import '../components/no_fav_widget.dart';
            ...
            child: Padding(
              ...
              child: StreamBuilder<List<OngsRecord>>(
                stream: queryOngsRecord(
                  queryBuilder: (ongsRecord) => ongsRecord
                      .where('favoritos', arrayContains: currentUserReference)
                      .orderBy('nombre'),
                ),
                builder: (context, snapshot) {
                  ...
                  List<OngsRecord> columnScrollOngsRecordList = snapshot.data;
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: List.generate(columnScrollOngsRecordList.length,
                          (columnScrollIndex) {
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          columnScrollOngsRecord.displayName,
