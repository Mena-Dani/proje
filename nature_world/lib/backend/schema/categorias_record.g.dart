...
class _$CategoriasRecord extends CategoriasRecord {
  ...
  _$CategoriasRecord._({this.nombre, this.img, this.reference}) : super._();
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, nombre.hashCode), img.hashCode), reference.hashCode));
  }
  ...
  _$CategoriasRecord build() {
    final _$result = _$v ??
        new _$CategoriasRecord._(
            nombre: nombre, img: img, reference: reference);
    replace(_$result);
    return _$result;
  }
}
